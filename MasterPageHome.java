 ...
 * @author mannu
 */
public class MasterPageHome extends javax.swing.JFrame 
{

    /** Creates new form MasterPage */
    public MasterPageHome() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnImageEnhancement.setText("Registration");
   ...
   r.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterPageHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       //    MasterPage().setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
        ...
        MasterPageHome p=new MasterPageHome();
        p.setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
        java.awt.EventQueue.invokeLater(new Runnable() {

            public void run() {
                new MasterPageHome().setVisible(true);
